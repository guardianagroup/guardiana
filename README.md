...
|---|---|---|
| Windows 10/11 (64 bits) | `guardiana-<versión>-windows-x64.msi` (en inglés, `…-x64-en.msi`; en portugués, `…-x64-pt.msi`) | Doble clic. Instala en Archivos de programa y registra el servicio. |
