...
La contraseña sale de la página al programa por 127.0.0.1 y no va a ningún otro sitio. **Para volver:**
arriba a la izquierda, «← Panel de GUARDIANA» lleva al panel principal (con su llave si el programa
puede leerla); en la terminal, Intro cierra la página y devuelve el menú.
